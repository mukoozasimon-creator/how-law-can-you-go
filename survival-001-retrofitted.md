...
receipts:
  - instrument: "Brendlin v. California"
    ...
    notes: "Unanimous. Controls federal Fourth Amendment standard. State constitutions may afford more protection."
  ...
  - instrument: "Maryland v. Wilson"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Court expressly declined to decide whether passengers may be forcibly detained for the entire duration of the stop."
  ...
  - instrument: "Arizona v. Johnson"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Applies Terry frisk standard to passengers. Reasonable suspicion must be individualized to the passenger."
  ...
  - instrument: "Berkemer v. McCarty"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Means no Miranda warning is required, but does not compel answers. Often misread as a duty to answer."
  ...
  - instrument: "Rodriguez v. United States"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Governs duration of stop, not passenger ID. Used here to show the clock limits the encounter."
  ...
  - instrument: "Hiibel v. Sixth Judicial District Court"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Upholds stop-and-identify statutes where reasonable suspicion exists. Explicitly says no physical ID document is required."
  ...
  - instrument: "United States v. Landeros"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Ninth Circuit only. Creates circuit split with Fourth and Eleventh Circuits."
  ...
  - instrument: "United States v. Soriano-Jarquin"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Fourth Circuit. Permits request for ID; does not compel production."
  ...
  - instrument: "Johnson v. Nocco"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Resolved on qualified immunity; court did not reach merits of whether demand for passenger ID violates Fourth Amendment."
  ...
  - instrument: "State v. Rankin"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Washington Constitution art. I, sec. 7. State constitutional protection above federal floor."
  ...
  - instrument: "Presley v. State"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Florida Supreme Court. Passenger detention is inherent in a lawful traffic stop."
  ...
  - instrument: "Rakas v. Illinois"
    ...
    review_date: "2026-08-25"
    source_verified: true
    notes: "Expensive trapdoor. Passenger generally cannot challenge vehicle search; must challenge the stop instead."

  - instrument: "Nevada Revised Statutes 171.123(3)"
    ...
    offset: "NRS 171.123(3), lines 1-3"
    repeal_checked: "2026-08-25"
    repeal_status: "active"
    verdict: "qualifies"
    review_date: "2026-08-25"
    source_verified: true
    notes: "Stop-and-identify statute. Requires reasonable suspicion. Does not apply to mere passengers without independent basis."

  - instrument: "Ohio Revised Code 2921.29"
    ...
    offset: "R.C. 2921.29(A), lines 1-3"
    repeal_checked: "2026-08-25"
    repeal_status: "active"
    verdict: "qualifies"
    review_date: "2026-08-25"
    source_verified: true
    notes: "Applies in public places. Does not explicitly mention passengers in vehicles."

  - instrument: "Illinois Compiled Statutes 725 ILCS 5/107-14"
    ...
    offset: "725 ILCS 5/107-14, lines 1-4"
    repeal_checked: "2026-08-25"
    repeal_status: "active"
    verdict: "qualifies"
    review_date: "2026-08-25"
    source_verified: false
    notes: "Read via ILGA portal. Official source is Illinois General Assembly. Stop-and-identify authority, not passenger-specific."

  - instrument: "Arizona Revised Statutes 13-2412"
    citation: "A.R.S. sec. 13-2412"
    ...
    offset: "A.R.S. 13-2412(A), lines 1-3"
    repeal_checked: "2026-08-25"
    repeal_status: "active"
    verdict: "qualifies"
    review_date: "2026-08-25"
    source_verified: true
    notes: "Requires prior advisement that refusal is unlawful. Applies after lawful detention."

  - instrument: "Texas Penal Code 38.02"
    ...
    offset: "Tex. Pen. Code 38.02(a), lines 1-3"
    repeal_checked: "2026-08-25"
    repeal_status: "active"
    verdict: "qualifies"
    review_date: "2026-08-25"
    source_verified: true
    notes: "Applies to lawfully arrested persons, not mere detainees. Texas also has operator-specific ID duties."
---
...
<li><strong>Your state constitution may give you more.</strong> Washington forbids even requesting passenger ID without an independent basis. <em>State v. Rankin</em>, 151 Wn.2d 689 (2004), under Wash. Const. art. I, sec. 7.</li>
